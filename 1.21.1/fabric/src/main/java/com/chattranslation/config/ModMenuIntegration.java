...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private Screen createScreen(Screen parent) {
        ...
        general.addEntry(entries.startBooleanToggle(Text.translatable("chattranslation.config.translate_outgoing_messages"), editing.isTranslateOutgoingMessages())
                .setDefaultValue(false)
                .setSaveConsumer(editing::setTranslateOutgoingMessages)
                .build());

        general.addEntry(entries.startStringDropdownMenu(Text.translatable("chattranslation.config.outgoing_target_language"), editing.getOutgoingTargetLanguage(), Text::literal)
